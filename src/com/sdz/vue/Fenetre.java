...
public class Fenetre extends JFrame implements Observer {
	...
	private char[] lettreTab = { 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q',
			'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z' };
	...
	public Fenetre(Observable obs) {
		...
		rules = new JMenuItem("R�gles du jeu");
		...
		apropos2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null, "Cr�ateur : Cysboy\nLicence : Freeware\nCopyright : cysboy@sdz.com",
	...
	public void accueil() {
		System.out.println("Mise � jour de l'accueil�");
		conteneur.removeAll();
